...
if __name__ == '__main__':
    ...
    for gds in x_labels:
        ...
        createDirectory('./Motivation_IS')
        repname = SArow+'x'+SAcol+'SA'
        repdir='./Motivation_IS/Scaleout_oldtile_Detail/'+toponame #./reports_detail/simname_toponame
        createDirectory('./Motivation_IS/Scaleout_oldtile_Detail')
        ...
        repdir2='./Motivation_IS/Scaleout_oldtile_Compact/'+toponame #./reports_compact/simname_toponame
        createDirectory('./Motivation_IS/Scaleout_oldtile_Compact')
        ...
        repdir3='./Motivation_IS/Scaleout_oldtile_perPod/'+toponame #./reports_compact/simname_toponame
        createDirectory('./Motivation_IS/Scaleout_oldtile_perPod')
