...
if __name__ == '__main__':
    ...
    Arr_row = int(SArow)
    Arr_col = int(SAcol)
    IF_SRAM = int(5242880) #512KB
    Fil_SRAM = int(5242880)
    OF_SRAM = 2621440
    ...
    repdir='./Evaluation1/Scaleout_oldtile_Detail/'+toponame #./reports_detail/simname_toponame
    createDirectory('./Evaluation1/Scaleout_oldtile_Detail')
    ...
    repdir2='./Evaluation1/Scaleout_oldtile_Compact/'+toponame #./reports_compact/simname_toponame
    createDirectory('./Evaluation1/Scaleout_oldtile_Compact')
    ...
    repdir3='./Evaluation1/Scaleout_oldtile_perPod/'+toponame #./reports_compact/simname_toponame
    createDirectory('./Evaluation1/Scaleout_oldtile_perPod')
