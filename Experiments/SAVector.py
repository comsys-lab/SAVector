...
if __name__ == '__main__':
    ...
    #'16x16':'MACs_sq_256','32x32':'MACs_sq_1024',} #Dictionary of sim configs
    # ('nxm':'config name') n and m are pod dimension.)
    #############################
