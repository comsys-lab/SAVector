...
if __name__ == '__main__':
    ...
    config_base = './configs/' #config파일 폴더
    # grid_arr_dict = {'1x1':'MACs_sq_1', '2x2':'MACs_sq_4', '4x4':'MACs_sq_16', '8x8':'MACs_sq_64', '16x16':'MACs_sq_256', '32x32':'MACs_sq_1024',}
    grid_arr_dict = {'1x1':'MACs_sq_1',}
    #############################
    ...
    for gds in x_labels:
        ...
        SArow = str(int(128/g_row))
        SAcol = str(int(128/g_col))

        createDirectory('./Motivation')
        repname = SArow+'x'+SAcol+'SA'
        repdir='./Motivation/Scaleout_oldtile_Detail/'+toponame #./reports_detail/simname_toponame
        createDirectory('./Motivation/Scaleout_oldtile_Detail')
        createDirectory(repdir)
        rep = open(repdir + '/' + repname + '.txt','w') #./reports/toponame/Detail/repname.txt

        cfgname = grid_arr_dict[gds]
        config_file = config_base + cfgname + '.cfg'
        ...
        repname2 = SArow+'x'+SAcol+'SA'
        repdir2='./Motivation/Scaleout_oldtile_Compact/'+toponame #./reports_compact/simname_toponame
        createDirectory('./Motivation/Scaleout_oldtile_Compact')
        ...
        repname3 = SArow+'x'+SAcol+'SA'
        repdir3='./Motivation/Scaleout_oldtile_perPod/'+toponame #./reports_compact/simname_toponame
        createDirectory('./Motivation/Scaleout_oldtile_perPod')
        createDirectory(repdir3)
        rep3 = open(repdir3 + '/' + repname3 + '.txt','w') #./reports/toponame/Detail/repname.txt
