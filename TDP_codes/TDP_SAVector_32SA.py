...
if __name__ == '__main__':
    ...
    Arr_row = int(SArow)
    Arr_col = int(SAcol)
    IF_SRAM = int(262144) #1MB
    Fil_SRAM = int(262144) #1MB
    OF_SRAM = 262144
    mkcfg(cfgname, dflow, Arr_row, Arr_col, IF_SRAM, Fil_SRAM, OF_SRAM)

    grid_arr_dict = {'4x4':cfgfname, '4x8':cfgfname, '8x4':cfgfname, '8x8':cfgfname, '8x16':cfgfname, '16x8':cfgfname, '16x16':cfgfname,}
    #############################
    ...
    for gds in x_labels:
        ...
        repname = "SAVector_" + "32x32SA_" + str(gds) + 'p'
