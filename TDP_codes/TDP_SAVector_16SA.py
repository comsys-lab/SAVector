...
if __name__ == '__main__':
    ...
    Arr_row = int(SArow)
    Arr_col = int(SAcol)
    IF_SRAM = int(131072) #1MB
    Fil_SRAM = int(131072) #1MB
    OF_SRAM = 131072
    mkcfg(cfgname, dflow, Arr_row, Arr_col, IF_SRAM, Fil_SRAM, OF_SRAM)

    grid_arr_dict = {'8x8':cfgfname, '8x16':cfgfname, '16x8':cfgfname, '16x16':cfgfname, '32x16':cfgfname, '16x32':cfgfname,}
    #############################
    ...
    for gds in x_labels:
        ...
        repname = "SAVector_" + "16x16SA_" + str(gds) + 'p'
