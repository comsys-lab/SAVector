...
def mkcfg(config_base, dataflow, SArow, SAcol, IF_SRAM, Fil_SRAM, OF_SRAM):
    ...
    Arr_H = int(SArow)
    Arr_W = int(SAcol)
    IF_SRAM = int(input_SRAM/(128/int(SArow))) 
    Fil_SRAM = int(weight_SRAM/(128/int(SAcol))) 
    OF_SRAM = int(output_SRAM/(128/int(SAcol)))
...
class scaled_out_simulator:
    ...
    def gather_stats(self, memory_system_obj, compute_system_obj,row_id, col_id, layer_id):
        ...
        fold_rt = (SA_row + SA_col + this_m - 2) # If you want to assume the weight double-buffering within the SA, modify "2*SA_row" to "SA_row".
        ...
        #
        this_active_PE = 100*(0.5*(SA_row + SA_col) + this_m - 1)/(SA_row + SA_col + this_m - 2)
...
if __name__ == '__main__':
    ...
    config_base = './configs/Scale_out/' # Config file folder
    Results_dir = './Moti_infbuf'
    input_SRAM = 50*1024*1024 # Total input SRAM of an accelerator, unit=Bytes
    weight_SRAM = 50*1024*1024 # Total weight SRAM of an accelerator, unit=Bytes
    output_SRAM = 50*1024*1024 # Total output SRAM of an accelerator, unit=Bytes
    ##################################
    ...
    for gds in x_labels:
        ...
        repdir = Results_dir + '/Scaleout_oldtile_Detail/'+toponame #./reports_detail/simname_toponame
        createDirectory(Results_dir + '/Scaleout_oldtile_Detail')
        ...
        repdir2=Results_dir + '/Scaleout_oldtile_Compact/'+toponame #./reports_compact/simname_toponame
        createDirectory(Results_dir+'/Scaleout_oldtile_Compact')
        ...
        # repdir3=Results_dir+'/Scaleout_oldtile_perPod/'+toponame #./reports_compact/simname_toponame
        # createDirectory(Results_dir+'/Scaleout_oldtile_perPod')
