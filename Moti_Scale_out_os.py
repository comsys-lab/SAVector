...
if __name__ == '__main__':
    ...
    for gds in x_labels:
        ...
        createDirectory('./Motivation_OS')
        repname = SArow+'x'+SAcol+'SA'
        repdir='./Motivation_OS/Scaleout_oldtile_Detail/'+toponame #./reports_detail/simname_toponame
        createDirectory('./Motivation_OS/Scaleout_oldtile_Detail')
        ...
        repdir2='./Motivation_OS/Scaleout_oldtile_Compact/'+toponame #./reports_compact/simname_toponame
        createDirectory('./Motivation_OS/Scaleout_oldtile_Compact')
        ...
        repdir3='./Motivation_OS/Scaleout_oldtile_perPod/'+toponame #./reports_compact/simname_toponame
        createDirectory('./Motivation_OS/Scaleout_oldtile_perPod')
