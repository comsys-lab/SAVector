...
class double_buffered_scratchpad:
    ...
    def set_params(self,
                   ...
                   get_input_dram=False, get_weight_dram=False):
    #default 파라미터들...
        ...
        # For faster sim
        self.get_input_dram = get_input_dram
        self.get_weight_dram = get_weight_dram
    ...
    def service_memory_requests_old(self, ifmap_demand_mat, filter_demand_mat, ofmap_demand_mat):
        ...
        while ofmap_lines_remaining > 0:
            ...
            print('ofmap_cycles_out: {}'.format(ofmap_cycles_out.shape)) ###########
