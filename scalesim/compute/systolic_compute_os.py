...
class systolic_compute_os:
    ...
    def set_params(self,
        ...
        #print("filter_op_mat={}".format(filter_op_mat.shape)) ################
    ...
    def create_demand_matrices(self):
        ...
        #print("ifmap demand:{} / arr_row:{}".format(self.ifmap_demand_matrix.shape[1],self.arr_row)) #####&&&&&#####
        ...
        #print("ifmap demand:{} / arr_row:{}".format(self.ifmap_demand_matrix.shape,self.arr_row)) #####&&&&&#####
    ...
    def create_ifmap_demand_mat(self):
        assert self.params_set_flag, 'Parameters are not set'
        #print("create_ifmap_demand_mat 실행됨") #############
        ...
        #print("col_fold: {}   row_fold: {}".format(self.col_fold, self.row_fold)) ############
        for fc in range(self.col_fold):
            for fr in range(self.row_fold):
                ...
                if fr == 0 and fc == 0:
                    ...
                    #print("fr:{}   fc:{}   ifmap_demand_matrix={}".format(fr, fc, self.ifmap_demand_matrix.shape)) ###########
                else:
