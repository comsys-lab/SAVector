...
class single_layer_sim:
    def __init__(self):
        ...
        self.op_mat_obj = opmat() # scalesim/compute디렉토리 operand_matrix.py의 operand_matrix클래스.
        self.compute_system = systolic_compute_os() # 얘도 scalesim/compute에 있음
        self.memory_system = mem_dbsp() #얘는 memory폴더에
    ...
    # mem_dbsp()는 scalesim/memory내의 double_buffered_scratchpad_mem.py에 있음.
