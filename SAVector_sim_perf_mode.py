...
if __name__ == '__main__':
    ...
    input_SRAM = 1048576+16384 # Total input SRAM of an accelerator, unit=Bytes
    weight_SRAM = 1048576+16384 # Total weight SRAM of an accelerator, unit=Bytes
    output_SRAM = 1048576+16384 # Total output SRAM of an accelerator, unit=Bytes
    ##################################
    ...
    for gds in x_labels:
        ...
        repname = SAdim + "SA_" + str(gds) + 'p' +'_batch' + str(batch_sz) # e.g., SAVector_perf_32x32SA_4x4p+B16
        repdir=Results_dir + '/SAVector_perf_Detail/'+toponame #./reports_detail/simname_toponame
        createDirectory(Results_dir + '/SAVector_perf_Detail')
        ...
        repdir2=Results_dir+'/SAVector_perf_Compact/'+toponame #./reports_compact/simname_toponame
        createDirectory(Results_dir+'/SAVector_perf_Compact')
