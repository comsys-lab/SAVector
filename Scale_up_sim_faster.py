...
if __name__ == '__main__':
    ...
    input_SRAM = 1.5*1024*1024 # Total input SRAM of an accelerator, unit=Bytes
    weight_SRAM = 1.5*1024*1024 # Total weight SRAM of an accelerator, unit=Bytes
    output_SRAM = 1*1024*1024 # Total output SRAM of an accelerator, unit=Bytes
    ##################################
    ...
    for gds in x_labels:
        ...
        repdir = Results_dir + '/Scaleup_Detail/'+toponame #./reports_detail/simname_toponame
        createDirectory(Results_dir + '/Scaleup_Detail')
        ...
        repdir2=Results_dir + '/Scaleup_Compact/'+toponame #./reports_compact/simname_toponame
        createDirectory(Results_dir+'/Scaleup_Compact')
        ...
        # repdir3=Results_dir+'/Scaleup_perPod/'+toponame #./reports_compact/simname_toponame
        # createDirectory(Results_dir+'/Scaleup_perPod')
